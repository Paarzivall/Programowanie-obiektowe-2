...
ZOMBIE_STAND_L = pygame.image.load(os.path.join('png', 'zombie_standL.png'))
...
ZOMBIE_IMAGES_LEFT = [ZOMBIE_WALK_L1, ZOMBIE_WALK_L2]
ZOMBIE_IMAGES_RIGHT = [ZOMBIE_WALK_R1, ZOMBIE_WALK_R2]